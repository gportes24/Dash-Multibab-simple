...
githublink = 'https://github.com/gportes24/Dash-Multibab-simple'
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs-example", value='tab-1-example',
            children=[
                dcc.Tab(label='One Mississippi', value='tab-1-example'),
                dcc.Tab(label='Two Mississippi', value='tab-2-example'),
                dcc.Tab(label='Three Mississippi', value='tab-3-example'),
    ]),
    html.Div([
...
def page_1_dropdown(value):
    return 'You picked "{}"'.format(value)
